...
namespace LabIV.Migrations
{
    ...
    [Migration("20190608140634_Add2NewDbContext")]
    partial class Add2NewDbContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabIV.Models.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("LabIV.Models.UserUserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("LabIV.Models.UserUserRole", b =>
                {
                    b.HasOne("LabIV.Models.User", "User")
                        .WithMany("UserUserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("LabIV.Models.UserRole", "UserRole")
                        .WithMany("UserUserRoles")
